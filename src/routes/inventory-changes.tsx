...
import {
  listInventoryChangeRequests,
  decideInventoryChangeRequest,
} from "@/lib/inventory-changes.functions";
    ...
    <div>
      ...
      {!isLoading && visible.length === 0 && (
        <EmptyState
          ...
          hint={
            filter === "pending"
              ? "When the team requests inventory changes, they'll queue here for review."
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    <StatusPill tone={ACTION_TONE[r.action] ?? "info"}>
