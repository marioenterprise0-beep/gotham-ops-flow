...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      alert_email_status: "none" | "queued" | "sent" | "failed" | "suppressed" | "skipped";
      alert_priority: "critical" | "high" | "normal" | "low";
      alert_status: "open" | "pending" | "approved" | "declined" | "resolved" | "archived";
      alert_type:
        | "missed_clock_out"
        | "missed_clock_in"
        | "time_adjustment"
      ...
      inventory_order_status:
        ...
        | "received"
        | "cancelled";
      inventory_order_urgency: "normal" | "needed_soon" | "critical" | "emergency";
      ...
      schedule_status: "draft" | "submitted" | "approved" | "locked" | "published";
      shift_phase: "opening" | "mid" | "closing" | "emergency";
      shift_segment: "open" | "mid" | "close" | "custom";
      shift_status: "active" | "closed";
      task_status: "todo" | "in_progress" | "done" | "signed_off" | "blocked" | "missed";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      ...
      inventory_order_urgency: ["normal", "needed_soon", "critical", "emergency"],
      location_request_status: ["pending", "approved", "declined", "cancelled", "used", "expired"],
      maintenance_status: ["open", "in_progress", "resolved"],
      org_billing_status: [
        "trialing",
        "trial_expired",
