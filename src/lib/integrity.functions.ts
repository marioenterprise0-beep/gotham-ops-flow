...
export const NAV_TAB_KEYS = [
  ...
  "schedule", "labor", "inventory", "order-guide", "sops", "handbook", "hr-documents", "hospitality", "maintenance",
...
export const runIntegritySweep = createServerFn({ method: "GET" })
  ...
  .handler(async ({ context }): Promise<IntegrityReport> => {
    ...
    pushIssue(issues, {
      category: "schedule", severity: "critical", code: "shift_orphan_schedule",
    ...
    const shiftsBadEmployee = shifts.filter((s: any) => s.employee_id && !profileIds.has(s.employee_id));
    pushIssue(issues, {
      category: "schedule", severity: "critical", code: "shift_missing_employee",
    ...
    const shiftsInactiveEmployee = shifts.filter(
      (s: any) => s.employee_id && profileIds.has(s.employee_id) && !activeProfileIds.has(s.employee_id),
    );
    pushIssue(issues, {
      category: "schedule", severity: "warning", code: "shift_inactive_employee",
    ...
    pushIssue(issues, {
      category: "labor", severity: "critical", code: "punch_missing_employee",
    ...
    pushIssue(issues, {
      category: "labor", severity: "warning", code: "punch_stuck_open",
    ...
    pushIssue(issues, {
      category: "labor", severity: "warning", code: "weekly_hours_over_cap",
    ...
    const [ordersRes, orderItemsRes, itemsRes] = await Promise.all([
      ...
      supabase.from("inventory_order_items").select("id, order_id, item_id, requested_qty, item_name"),
    ...
    pushIssue(issues, {
      category: "inventory", severity: "critical", code: "order_item_orphan_order",
    ...
    pushIssue(issues, {
      category: "inventory", severity: "warning", code: "order_item_missing_inventory",
    ...
    pushIssue(issues, {
      category: "inventory", severity: "warning", code: "order_item_zero_qty",
    ...
    pushIssue(issues, {
      category: "inventory", severity: "critical", code: "item_negative_stock",
    ...
    pushIssue(issues, {
      category: "permissions", severity: "warning", code: "perm_unknown_tab",
    ...
    pushIssue(issues, {
      category: "permissions", severity: "warning", code: "perm_bad_scope",
    ...
    pushIssue(issues, {
      category: "permissions", severity: "warning", code: "perm_dangling_user",
    ...
    pushIssue(issues, {
      category: "users", severity: "critical", code: "profile_no_role",
    ...
    pushIssue(issues, {
      category: "users", severity: "warning", code: "role_no_profile",
