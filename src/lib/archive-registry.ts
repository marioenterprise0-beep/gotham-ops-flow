...
export const ARCHIVE_DOMAINS: ArchiveDomain[] = [
  ...
  },
  {
    ...
    nameColumn: "title",
    deps: [{ table: "tasks", column: "template_id", label: "Generated tasks" }],
  },
  {
    table: "schedules",
    label: "Schedules",
    nameColumn: "name",
    deps: [{ table: "schedule_shifts", column: "schedule_id", label: "Shifts" }],
  },
  {
    table: "schedule_shifts",
    label: "Schedule Shifts",
    deps: [{ table: "time_punches", column: "shift_id", label: "Time punches" }],
  },
  ...
  { table: "inventory_change_requests", label: "Change Requests", deps: [] },
  {
    ...
    label: "Alerts",
    nameColumn: "title",
    deps: [{ table: "alert_actions", column: "alert_id", label: "Actions" }],
  },
