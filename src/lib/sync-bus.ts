...
const MAP: Record<SyncDomain, string[][]> = {
  ...
  schedule:     [["schedule-range"], ["schedule"], ["employees"], ["labor-dash"], ["emp-week"], ["my-week"], ["my-shifts"], ["dashboard-stats"], ["alerts"], ["change-log"]],
  timeclock:    [["my-active-punch"], ["my-week"], ["my-shifts"], ["emp-week"], ["labor-dash"], ["labor-reqs"], ["my-requests"], ["schedule"], ["schedule-range"], ["dashboard-stats"], ["change-log"]],
