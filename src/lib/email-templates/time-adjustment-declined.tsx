...
const Email = ({ recipient_name, shift_date, decision_reason, decided_by, punch_id }: Props) => (
  <BrandLayout preview="Time adjustment declined">
    ...
    <Text style={styles.text}>
      {recipient_name ? `Hi ${recipient_name}, your` : 'Your'} time correction for {shift_date ?? 'the requested shift'} was declined{decided_by ? ` by ${decided_by}` : ''}. Reach out to your manager if you'd like to discuss it.
    </Text>
    <DataTable>
...
export const template = {
  ...
  previewData: { recipient_name: 'Sara', shift_date: 'Mon Dec 9', decision_reason: 'Mismatch with door camera', decided_by: 'Omar' },
