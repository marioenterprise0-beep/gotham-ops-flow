...
const Email = ({
  ...
  <BrandLayout preview={`Schedule updated — ${week_range ?? ""}`}>
    ...
    <Text style={styles.text}>
      ...
      {changed_by ?? "A manager"} updated the schedule for {week_range ?? "this period"}. Please
...
export const template = {
  ...
  previewData: {
    changed_by: "Aisha Khan",
    week_range: "Dec 9 – Dec 15",
    location: "Location 1",
    changes: [{ field: "Tue Dec 10", from: "10–6", to: "12–8" }],
  },
