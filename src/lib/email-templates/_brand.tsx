...
const PUBLIC_APP_URL = 'https://gothamhalaldash.com'
    ...
    <Body style={styles.main}>
      <Container style={styles.shell}>
        ...
        <Section style={styles.footer}>
          <Text style={styles.footerBrand}>Generated by Gotham OS</Text>
          <Text style={{ margin: '0', color: '#9A9A9A' }}>
            This notification was sent based on activity inside Gotham OS.
          </Text>
...
// Convenience: rendered "Open Gotham OS" CTA
export const OpenGothamButton = ({ path = '/', label = 'Open Gotham OS' }: { path?: string; label?: string }) => (
