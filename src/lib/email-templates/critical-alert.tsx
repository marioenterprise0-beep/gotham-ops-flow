...
const Email = ({
  ...
  <BrandLayout preview={`CRITICAL — ${alert_title ?? ""}`}>
    ...
    <Text style={styles.text}>
      {recipient_name ? `${recipient_name}, ` : ""}a critical issue was raised in Dip N Shake OS and
...
export const template = {
  component: Email,
  subject: (d: any) => `CRITICAL: ${d?.alert_title ?? "Alert"}`,
  displayName: "Critical Alert",
  previewData: {
    alert_title: "Walk-in cooler down",
    alert_description: "Temperature sensor reports 51°F sustained for 30 min.",
