...
const Email = ({
  ...
  <BrandLayout preview="Inventory order approved">
    ...
    <Text style={styles.text}>
      {recipient_name ? `${recipient_name}, ` : ""}your inventory order has been approved
      {approver_name ? ` by ${approver_name}` : ""} and is ready to be placed with the vendor.
    </Text>
    <DataTable>
...
export const template = {
  component: Email,
  subject: "Inventory order approved",
  displayName: "Inventory Order Approved",
  previewData: {
