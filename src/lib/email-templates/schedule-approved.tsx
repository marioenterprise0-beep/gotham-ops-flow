...
const Email = ({
  ...
  <BrandLayout preview={`Schedule approved — ${week_range ?? ""}`}>
    ...
    <Text style={styles.text}>
      {recipient_name ? `${recipient_name}, ` : ""}the schedule for{" "}
      {week_range ?? "the upcoming week"} has been approved
      {approver_name ? ` by ${approver_name}` : ""} and is ready to publish to the crew.
    </Text>
    <DataTable>
