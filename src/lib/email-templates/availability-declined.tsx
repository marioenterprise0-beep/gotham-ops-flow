...
const Email = ({ recipient_name, block_date, decided_by, decision_reason }: Props) => (
  <BrandLayout preview="Unavailability declined">
    ...
    <Text style={styles.text}>
      ...
      {block_date ? ` on ${block_date}` : ''} was declined{decided_by ? ` by ${decided_by}` : ''}. Please plan
      to work your scheduled shift, or reach out to your manager if this is an emergency.
    </Text>
    <DataTable>
...
export const template = {
  ...
  previewData: { recipient_name: 'Sara', block_date: 'Sat Dec 14', decided_by: 'Mario', decision_reason: 'Too short notice' },
