...
const Email = ({ recipient_name, start_date, end_date, decision_reason, decided_by }: Props) => (
  <BrandLayout preview="Time off request declined">
    ...
    <Text style={styles.text}>
      {recipient_name ? `Hi ${recipient_name}, your` : "Your"} time off request was declined
      {decided_by ? ` by ${decided_by}` : ""}. Reach out to your manager if you'd like to discuss
      it.
    </Text>
    <DataTable>
      <DataRow
...
export const template = {
  ...
  previewData: {
    ...
    end_date: "Wed Dec 11",
    decision_reason: "Short-staffed that week",
    decided_by: "Mario",
  },
