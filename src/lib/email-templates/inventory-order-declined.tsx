...
const Email = ({ recipient_name, decided_by, location, owner_comment, order_id }: Props) => (
  <BrandLayout preview="Inventory order declined">
    ...
    <Text style={styles.text}>
      {recipient_name ? `${recipient_name}, ` : ""}your inventory order was declined
      {decided_by ? ` by ${decided_by}` : ""}. See notes below and resubmit when ready.
    </Text>
    <DataTable>
...
export const template = {
  component: Email,
  subject: "Inventory order declined",
  displayName: "Inventory Order Declined",
  previewData: {
    recipient_name: "Aisha",
    decided_by: "Omar",
    location: "Location 1",
    owner_comment: "Wait until Friday delivery.",
  },
